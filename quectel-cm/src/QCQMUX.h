...
typedef struct _QMI_WDA_SET_LOOPBACK_CONFIG_REQ_MSG {
    ...
    *PQMI_WDA_SET_LOOPBACK_CONFIG_REQ_MSG;
...
typedef struct _QMI_WDA_SET_LOOPBACK_CONFIG_IND_MSG {
    ...
    *PQMI_WDA_SET_LOOPBACK_CONFIG_IND_MSG;
...
typedef struct _QMIWDS_GET_RUNNING_SETTINGS_PCSCF_IPV6_ADDR {
    ...
    *PQMIWDS_GET_RUNNING_SETTINGS_PCSCF_IPV6_ADDR;

typedef struct _QMIWDS_GET_RUNNING_SETTINGS_PCSCF_IPV4_ADDR {
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  PCSCFNumber;
} __attribute__((packed)) QMIWDS_GET_RUNNING_SETTINGS_PCSCF_IPV4_ADDR,
    *PQMIWDS_GET_RUNNING_SETTINGS_PCSCF_IPV4_ADDR;
...
typedef struct _QMIWDS_SET_AUTO_CONNECT_REQ_MSG {
    ...
    USHORT TLVLength; // 1
    UCHAR
    autoconnect_setting; //  0x00 ?C Disabled, 0x01 ?C Enabled, 0x02 ?C Paused (resume on power cycle)
...
typedef struct _QMI_QOS_BIND_DATA_PORT_TLV_DATA_PORT {
    ...
    USHORT TLVLength;
    USHORT data_port;
} __attribute__((packed)) QMI_QOS_BIND_DATA_PORT_TLV_DATA_PORT,
    *PQMI_QOS_BIND_DATA_PORT_TLV_DATA_PORT;
...
} __attribute__((packed)) QMI_QOS_INDICATION_REGISTER_TLV_REPORT_GLOBAL_QOS_FLOW,
    *PQMI_QOS_INDICATION_REGISTER_TLV_REPORT_GLOBAL_QOS_FLOW;

typedef struct _QMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_REPORT_FLOW_CTL {
    UCHAR  TLVType; //0x11
    USHORT TLVLength;
    UCHAR  suppress_report_flow_control;
} __attribute__((packed)) QMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_REPORT_FLOW_CTL,
    *PQMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_REPORT_FLOW_CTL;

typedef struct _QMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_NW_STATUS_IND {
    UCHAR  TLVType; //0x12
    USHORT TLVLength;
    UCHAR  suppress_network_status_ind;
} __attribute__((packed)) QMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_NW_STATUS_IND,
    *PQMI_QOS_INDICATION_REGISTER_TLV_SUPPRESS_NW_STATUS_IND;
...
} __attribute__((packed)) QMI_QOS_INDICATION_REGISTER_REQ_MSG,
    *PQMI_QOS_INDICATION_REGISTER_REQ_MSG;
...
typedef struct _QMI_QOS_INDICATION_REGISTER_RESP_MSG {
    ...
    *PQMI_QOS_INDICATION_REGISTER_RESP_MSG;
...
typedef struct _QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_STATE {
    ...
    UCHAR  new_flow;
    ULONG  state_change;
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_STATE,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_STATE;
...
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_GRANTED,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_GRANTED;
...
typedef struct _QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_TYPE {
    ...
    USHORT TLVLength;
    ULONG  flow_type;
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_TYPE,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_TYPE;

typedef struct _QMI_QOS_GLOBAL_QOS_FLOW_TLV_BEARER_ID {
    UCHAR  TLVType; //0x15
    USHORT TLVLength;
    UCHAR  bearer_id;
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_BEARER_ID,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_BEARER_ID;

typedef struct _QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_CTL_SEQ_NUM {
    UCHAR  TLVType; //0x16
    USHORT TLVLength;
    USHORT fc_seq_num;
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_CTL_SEQ_NUM,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_FLOW_CTL_SEQ_NUM;
...
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_AVG_WINDOW,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_AVG_WINDOW;
...
typedef struct _QMI_QOS_GLOBAL_QOS_FLOW_TLV_TX_FILTER_MATCH_ALL {
    ...
    USHORT filter_id;
} __attribute__((packed)) QMI_QOS_GLOBAL_QOS_FLOW_TLV_TX_FILTER_MATCH_ALL,
    *PQMI_QOS_GLOBAL_QOS_FLOW_TLV_TX_FILTER_MATCH_ALL;
...
typedef struct _QMI_QOS_GET_QOS_INFO_TLV_FLOW_STATUS {
    ...
    USHORT TLVLength;
    UCHAR  flow_status;
} __attribute__((packed)) QMI_QOS_GET_QOS_INFO_TLV_FLOW_STATUS,
    *PQMI_QOS_GET_QOS_INFO_TLV_FLOW_STATUS;
...
typedef struct _QMI_QOS_GET_QOS_INFO_TLV_GRANTED_FLOW {
    ...
    UCHAR   ip_flow_3gpp_sig_ind;
    ULONG   ip_flow_lte_qci;
} __attribute__((packed)) QMI_QOS_GET_QOS_INFO_TLV_GRANTED_FLOW,
    *PQMI_QOS_GET_QOS_INFO_TLV_GRANTED_FLOW;
...
typedef struct _QMI_QOS_GET_QOS_INFO_TLV_FILTER_SPECS {
    ...
    *PQMI_QOS_GET_QOS_INFO_TLV_FILTER_SPECS;

typedef struct _QMI_QOS_GET_QOS_INFO_TLV_EXT_ERROR_INFO {
    UCHAR  TLVType; //0x15
    USHORT TLVLength;
    USHORT ext_error_info;
} __attribute__((packed)) QMI_QOS_GET_QOS_INFO_TLV_EXT_ERROR_INFO,
    *PQMI_QOS_GET_QOS_INFO_TLV_EXT_ERROR_INFO;
...
} __attribute__((packed)) QMI_QOS_GET_QOS_INFO_TLV_AVG_WINDOW,
    *PQMI_QOS_GET_QOS_INFO_TLV_AVG_WINDOW;
...
typedef struct _QMI_QOS_GET_QOS_INFO_TLV_TX_FILTER_MATCH_ALL {
    ...
    UCHAR  tx_filter_match_all_len;
    USHORT filter_id;
} __attribute__((packed)) QMI_QOS_GET_QOS_INFO_TLV_TX_FILTER_MATCH_ALL,
    *PQMI_QOS_GET_QOS_INFO_TLV_TX_FILTER_MATCH_ALL;
...
} __attribute__((packed)) QMI_COEX_GET_WWAN_STATE_RESP_MSG_LTE_BAND,
